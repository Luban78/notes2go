...
function otevriVlastniVyberData({
  ...
  /* PATCH 543 – datum/čas jsou sekundární modaly, ne textové editory.
     Klávesnici schováme ještě PŘED vykreslením kalendáře, aby na mobilu
     nezmenšila viewport a nepřekryla spodní část modalu. */
...
function otevriVlastniVyberCasu({
  ...
  /* Stejný modal keyboard contract jako u výběru data. */
  window.LubaNoteKeyboard?.skryjProModal?.();
...
function zobrazHlavniAkceKarty() {
  ...
  /*
   * PATCH 557 – vrací odladěnou akci Skryté z 538.
   * Hotovo už je na kartě dostupné swipem doprava, takže akční panel
   * nesmí znovu zabírat stejné místo duplicitní akcí Hotovo.
   * Shared poznámku zatím nelze skrývat private příznakem hiddenAt.
   */

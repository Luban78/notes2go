...
(() => {
  ...
  function vytvor() {
    ...
    ["screen","share","grid","dayh","daygap","dayrad","dayfont","apad","arad","afont","rowpad","rowmin","rowgap","time","sh","sr","sg","sfont"].forEach(k=>refs[k]=panel.querySelector(`#dpv-${k}`));

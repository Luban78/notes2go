...
(() => {
  ...
  function vytvorPanel() {
    ...
    <div class="ln-nvt-body">
      ...
      <div id="ln-dnvt-icons" hidden>
        <div class="ln-nvt-section-title">Ikony</div>
        ${rangeRadek({id:"ln-dnvt-classic-icon-size",label:"Velikost běžné / emoji ikony",min:14,max:36})}
        <div id="ln-dnvt-svg" hidden>
          ${rangeRadek({id:"ln-dnvt-icon-size",label:"Velikost SVG ikony",min:14,max:36})}
          ${rangeRadek({id:"ln-dnvt-icon-stroke",label:"Tloušťka SVG čáry",min:.8,max:2.4,step:.05})}
        </div>
      </div>
      ...
      <div class="ln-nvt-section-title">Levý boční panel</div>
      ${rangeRadek({id:"ln-dnvt-sidebar-width",label:"Šířka panelu",min:190,max:320})}
      ${rangeRadek({id:"ln-dnvt-sidebar-item-height",label:"Výška položky",min:34,max:66})}
      ${rangeRadek({id:"ln-dnvt-sidebar-icon-size",label:"Velikost SVG ikony",min:14,max:32})}
      ${rangeRadek({id:"ln-dnvt-sidebar-classic-icon-size",label:"Velikost běžné / emoji ikony",min:14,max:34})}
      ${rangeRadek({id:"ln-dnvt-sidebar-text-size",label:"Velikost textu",min:12,max:21})}
      ${rangeRadek({id:"ln-dnvt-sidebar-gap",label:"Mezera položek",min:0,max:18})}
      ${rangeRadek({id:"ln-dnvt-sidebar-radius",label:"Zaoblení položek",min:0,max:22})}
      ${rangeRadek({id:"ln-dnvt-sidebar-logo-size",label:"Velikost loga",min:36,max:72})}
      ${rangeRadek({id:"ln-dnvt-sidebar-pad-x",label:"Boční odsazení panelu",min:8,max:28})}
    ...
    refs = Object.fromEntries([
      ["head",".ln-nvt-head"],["subtitle","#ln-dnvt-subtitle"],["minimize","#ln-dnvt-minimize"],["close","#ln-dnvt-close"],["target","#ln-dnvt-target"],["border","#ln-dnvt-border"],["resetTarget","#ln-dnvt-reset-target"],["mode","#ln-dnvt-mode"],["width","#ln-dnvt-width"],["strength","#ln-dnvt-strength"],["radius","#ln-dnvt-radius"],["size","#ln-dnvt-size"],["icons","#ln-dnvt-icons"],["svg","#ln-dnvt-svg"],["classicIconSize","#ln-dnvt-classic-icon-size"],["iconSize","#ln-dnvt-icon-size"],["iconStroke","#ln-dnvt-icon-stroke"],["offset","#ln-dnvt-offset"],["toolbarHeight","#ln-dnvt-toolbar-height"],["toolbarGap","#ln-dnvt-toolbar-gap"],["filterGap","#ln-dnvt-filter-gap"],["toolbarTagsGap","#ln-dnvt-toolbar-tags-gap"],["tagsGap","#ln-dnvt-tags-gap"],["tagsCardsGap","#ln-dnvt-tags-cards-gap"],["cardColGap","#ln-dnvt-card-col-gap"],["cardRowGap","#ln-dnvt-card-row-gap"],["sidebarWidth","#ln-dnvt-sidebar-width"],["sidebarItemHeight","#ln-dnvt-sidebar-item-height"],["sidebarIconSize","#ln-dnvt-sidebar-icon-size"],["sidebarClassicIconSize","#ln-dnvt-sidebar-classic-icon-size"],["sidebarTextSize","#ln-dnvt-sidebar-text-size"],["sidebarGap","#ln-dnvt-sidebar-gap"],["sidebarRadius","#ln-dnvt-sidebar-radius"],["sidebarLogoSize","#ln-dnvt-sidebar-logo-size"],["sidebarPadX","#ln-dnvt-sidebar-pad-x"],["copy","#ln-dnvt-copy"],["resetAll","#ln-dnvt-reset-all"],["center","#ln-dnvt-center"]
  ...
  function aktualizuj() {
    ...
    const maIkony = ["modules","search","primary","actions"].includes(id);
    const maSvg = maIkony;
    refs.icons.hidden = !maIkony;
    refs.svg.hidden = !maSvg;
    if (maIkony) nastavRange(refs.classicIconSize,p.klasickaIkonaVelikost,o.klasickaIkonaVelikost);
    if (maSvg){nastavRange(refs.iconSize,p.ikonaVelikost,o.ikonaVelikost);nastavRange(refs.iconStroke,p.ikonaTloustka,o.ikonaTloustka);}
    for (const [ref,k] of [[refs.offset,"offsetY"],[refs.toolbarHeight,"toolbarVyska"],[refs.toolbarGap,"toolbarMezera"],[refs.filterGap,"filtryMezera"],[refs.toolbarTagsGap,"toolbarStitkyMezera"],[refs.tagsGap,"stitkyMezera"],[refs.tagsCardsGap,"stitkyKartyMezera"],[refs.cardColGap,"kartySloupceMezera"],[refs.cardRowGap,"kartyRadkyMezera"],[refs.sidebarWidth,"sidebarSirka"],[refs.sidebarItemHeight,"sidebarPolozkaVyska"],[refs.sidebarIconSize,"sidebarIkonaVelikost"],[refs.sidebarClassicIconSize,"sidebarKlasikIkonaVelikost"],[refs.sidebarTextSize,"sidebarTextVelikost"],[refs.sidebarGap,"sidebarMezera"],[refs.sidebarRadius,"sidebarRadius"],[refs.sidebarLogoSize,"sidebarLogoVelikost"],[refs.sidebarPadX,"sidebarPaddingX"]]) nastavRange(ref,s.layout[k],v.layout[k]);
  }
